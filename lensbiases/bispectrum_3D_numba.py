...
P2D, Plin2D, nefff, integrate, zofchi, Wkk, kNLzf, s8, eval_linear_numba, Q = iqn.InterpolatedQuantitiesNumba("numbaproducts")
...
def integrate_bispectrum_kkk_TR_scipy(l1, l2, l3, angle12, angle13, angle23):
    ...
    def bispectrum_at_ells_of_chi(chi): 
        return chi**(-4)*Wkk(chi)**3*bispectrum_matter_TR(l1/chi, l2/chi, l3/chi, angle12, angle13, angle23, zofchi(chi))
...
chipow_4_times_Wkk3_pre_calc = xsgauss**(-4)*Wkk(xsgauss)**3
...
def integrate_bispectrum_kkk_TR_cos_scipy_from_triangle(l1, l2, l3):
    ...
    def bispectrum_at_ells_of_chi(chi): 
        ...
        return chi**(-4)*Wkk(chi)**3*bispectrum_matter_cos_TR(l1/chi, l2/chi, l3/chi, cangle12, cangle13, cangle23, zofchi(chi))
